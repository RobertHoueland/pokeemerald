...
static const struct WindowTemplate sWindowTemplate_StartClock = {
    ...
    .tilemapLeft = 1, 
    .tilemapTop = 1, 
    .width = 9, // If you want to shorten the dates to Full days, change this to 13
    .height = 2, 
    .paletteNum = 15,
    .baseBlock = 0x30
};
...
// If you want to shorten the dates to Full days, change this to 13
...
static u8 SaveFileExistsCallback(void)
{
    ...
    {
        sSaveDialogCallback = SaveSavingMessageCallback; // no extra confirmation
    }
