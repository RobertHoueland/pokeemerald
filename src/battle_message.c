...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_MUTSTATSHP]                           = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} feels heartier!{PAUSE 127}\p"),
    [STRINGID_MUTSTATSATT]                          = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} feels stronger!{PAUSE 127}\p"),
    [STRINGID_MUTSTATSDEF]                          = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} hardened its stance!{PAUSE 127}\p"),
    [STRINGID_MUTSTATSSPATK]                        = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} flared up!{PAUSE 127}\p"),
    [STRINGID_MUTSTATSSPDEF]                        = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} steadied its focus!{PAUSE 127}\p"),
    [STRINGID_MUTSTATSSPD]                          = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} feels quicker!{PAUSE 127}\p"),
