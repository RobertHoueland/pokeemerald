...
const u8 gText_MonMutated[] = _("Oh?\n{STR_VAR_1} is undergoing a mutation!{PAUSE_UNTIL_PRESS}");
const u8 gText_MutationStatsHp[] = _("{STR_VAR_1} feels heartier!{PAUSE_UNTIL_PRESS}");
const u8 gText_MutationStatsAttack[] = _("{STR_VAR_1} feels stronger!{PAUSE_UNTIL_PRESS}");
const u8 gText_MutationStatsDefense[] = _("{STR_VAR_1} hardened its stance!{PAUSE_UNTIL_PRESS}");
const u8 gText_MutationStatsSpAtk[] = _("{STR_VAR_1} flared up!{PAUSE_UNTIL_PRESS}");
const u8 gText_MutationStatsSpDef[] = _("{STR_VAR_1} steadied its focus!{PAUSE_UNTIL_PRESS}");
const u8 gText_MutationStatsSpd[] = _("{STR_VAR_1} feels quicker!{PAUSE_UNTIL_PRESS}");
const u8 gText_MutationType[] = _("{STR_VAR_1}'s cells restructured!\nIt exhibits the {STR_VAR_2} type.{PAUSE_UNTIL_PRESS}");
const u8 gText_MutationAbility[] = _("{STR_VAR_1}'s biology was altered...\nIts hidden ability manifested!{PAUSE_UNTIL_PRESS}");
const u8 gText_MutationNature[] = _("{STR_VAR_1} shows a new temperament!\nIt looks so {STR_VAR_2}.{PAUSE_UNTIL_PRESS}");
