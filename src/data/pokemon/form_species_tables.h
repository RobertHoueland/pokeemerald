...
static const u16 sSilvallyVFormSpeciesIdTable[] = {
    ...
    SPECIES_SILVALLY_V_FLYING,
    SPECIES_SILVALLY_V_POISON,
    SPECIES_SILVALLY_V_GROUND,
    SPECIES_SILVALLY_V_ROCK,
    SPECIES_SILVALLY_V_BUG,
    SPECIES_SILVALLY_V_GHOST,
    SPECIES_SILVALLY_V_STEEL,
    SPECIES_SILVALLY_V_FIRE,
    SPECIES_SILVALLY_V_WATER,
    SPECIES_SILVALLY_V_GRASS,
    SPECIES_SILVALLY_V_ELECTRIC,
    SPECIES_SILVALLY_V_PSYCHIC,
    SPECIES_SILVALLY_V_ICE,
    SPECIES_SILVALLY_V_DRAGON,
    SPECIES_SILVALLY_V_DARK,
    SPECIES_SILVALLY_V_FAIRY,
    FORM_SPECIES_END,
};
