...
static const struct FormChange sTornadusVFormChangeTable[] = {
    {FORM_CHANGE_ITEM_USE, SPECIES_TORNADUS_V_THERIAN, ITEM_REVEAL_GLASS},
    {FORM_CHANGE_ITEM_USE, SPECIES_TORNADUS_V_INCARNATE, ITEM_REVEAL_GLASS},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sThundurusVFormChangeTable[] = {
    {FORM_CHANGE_ITEM_USE, SPECIES_THUNDURUS_V_THERIAN, ITEM_REVEAL_GLASS},
    {FORM_CHANGE_ITEM_USE, SPECIES_THUNDURUS_V_INCARNATE, ITEM_REVEAL_GLASS},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sLandorusVFormChangeTable[] = {
    {FORM_CHANGE_ITEM_USE, SPECIES_LANDORUS_V_THERIAN, ITEM_REVEAL_GLASS},
    {FORM_CHANGE_ITEM_USE, SPECIES_LANDORUS_V_INCARNATE, ITEM_REVEAL_GLASS},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sXerneasVFormChangeTable[] = {
    {FORM_CHANGE_BEGIN_BATTLE, SPECIES_XERNEAS_V_ACTIVE},
    {FORM_CHANGE_END_BATTLE,   SPECIES_XERNEAS_V_NEUTRAL},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sGiratinaVFormChangeTable[] = {
    {FORM_CHANGE_ITEM_HOLD, SPECIES_GIRATINA_V_ALTERED, ITEM_NONE},
#if I_GRISEOUS_ORB_FORM_CHANGE < GEN_9
    {FORM_CHANGE_ITEM_HOLD, SPECIES_GIRATINA_V_ORIGIN, ITEM_GRISEOUS_ORB},
#endif
    {FORM_CHANGE_ITEM_HOLD, SPECIES_GIRATINA_V_ORIGIN, ITEM_GRISEOUS_CORE},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sDialgaVFormChangeTable[] = {
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DIALGA_V, ITEM_NONE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DIALGA_V_ORIGIN, ITEM_ADAMANT_CRYSTAL},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sPalkiaVFormChangeTable[] = {
    {FORM_CHANGE_ITEM_HOLD, SPECIES_PALKIA_V, ITEM_NONE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_PALKIA_V_ORIGIN, ITEM_LUSTROUS_GLOBE},
    {FORM_CHANGE_TERMINATOR},
};

static const struct Fusion sKyuremVFusionTable[] = {
    {0, ITEM_DNA_SPLICERS, SPECIES_KYUREM_V, SPECIES_RESHIRAM_V, SPECIES_KYUREM_V_WHITE, MOVE_NONE, SWAP_EXTRA_MOVES_KYUREM_WHITE},
    {0, ITEM_DNA_SPLICERS, SPECIES_KYUREM_V, SPECIES_ZEKROM_V, SPECIES_KYUREM_V_BLACK, MOVE_NONE, SWAP_EXTRA_MOVES_KYUREM_BLACK},
    {FUSION_TERMINATOR},
};

static const struct FormChange sSilvallyVFormChangeTable[] = {
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_V_NORMAL,   ITEM_NONE,            ABILITY_RKS_SYSTEM},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_V_FIGHTING, ITEM_FIGHTING_MEMORY, ABILITY_RKS_SYSTEM},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_V_FLYING,   ITEM_FLYING_MEMORY,   ABILITY_RKS_SYSTEM},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_V_POISON,   ITEM_POISON_MEMORY,   ABILITY_RKS_SYSTEM},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_V_GROUND,   ITEM_GROUND_MEMORY,   ABILITY_RKS_SYSTEM},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_V_ROCK,     ITEM_ROCK_MEMORY,     ABILITY_RKS_SYSTEM},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_V_BUG,      ITEM_BUG_MEMORY,      ABILITY_RKS_SYSTEM},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_V_GHOST,    ITEM_GHOST_MEMORY,    ABILITY_RKS_SYSTEM},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_V_STEEL,    ITEM_STEEL_MEMORY,    ABILITY_RKS_SYSTEM},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_V_FIRE,     ITEM_FIRE_MEMORY,     ABILITY_RKS_SYSTEM},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_V_WATER,    ITEM_WATER_MEMORY,    ABILITY_RKS_SYSTEM},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_V_GRASS,    ITEM_GRASS_MEMORY,    ABILITY_RKS_SYSTEM},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_V_ELECTRIC, ITEM_ELECTRIC_MEMORY, ABILITY_RKS_SYSTEM},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_V_PSYCHIC,  ITEM_PSYCHIC_MEMORY,  ABILITY_RKS_SYSTEM},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_V_ICE,      ITEM_ICE_MEMORY,      ABILITY_RKS_SYSTEM},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_V_DRAGON,   ITEM_DRAGON_MEMORY,   ABILITY_RKS_SYSTEM},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_V_DARK,     ITEM_DARK_MEMORY,     ABILITY_RKS_SYSTEM},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_V_FAIRY,    ITEM_FAIRY_MEMORY,    ABILITY_RKS_SYSTEM},
    {FORM_CHANGE_TERMINATOR},
};
