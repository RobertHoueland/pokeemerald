...
enum NationalDexOrder
{
    ...
    NATIONAL_DEX_DEOXYS,
    NATIONAL_DEX_MEWTWO_V,
    NATIONAL_DEX_ARTICUNO_V,
    NATIONAL_DEX_ZAPDOS_V,
    NATIONAL_DEX_MOLTRES_V,
    NATIONAL_DEX_RAIKOU_V,
    NATIONAL_DEX_ENTEI_V,
    NATIONAL_DEX_SUICUNE_V,
    NATIONAL_DEX_LUGIA_V,
    NATIONAL_DEX_HO_OH_V,
    NATIONAL_DEX_REGIROCK_V,
    NATIONAL_DEX_REGICE_V,
    NATIONAL_DEX_REGISTEEL_V,
    NATIONAL_DEX_LATIAS_V,
    NATIONAL_DEX_LATIOS_V,
    NATIONAL_DEX_KYOGRE_V,
    NATIONAL_DEX_GROUDON_V,
    NATIONAL_DEX_RAYQUAZA_V,
    NATIONAL_DEX_UXIE_V,
    NATIONAL_DEX_MESPRIT_V,
    NATIONAL_DEX_AZELF_V,
    NATIONAL_DEX_DIALGA_V,
    NATIONAL_DEX_PALKIA_V,
    NATIONAL_DEX_GIRATINA_V,
    NATIONAL_DEX_HEATRAN_V,
    NATIONAL_DEX_REGIGIGAS_V,
    NATIONAL_DEX_CRESSELIA_V,
    NATIONAL_DEX_COBALION_V,
    NATIONAL_DEX_TERRAKION_V,
    NATIONAL_DEX_VIRIZION_V,
    NATIONAL_DEX_TORNADUS_V,
    NATIONAL_DEX_THUNDURUS_V,
    NATIONAL_DEX_LANDORUS_V,
    NATIONAL_DEX_RESHIRAM_V,
    NATIONAL_DEX_ZEKROM_V,
    NATIONAL_DEX_KYUREM_V,
    NATIONAL_DEX_XERNEAS_V,
    NATIONAL_DEX_YVELTAL_V,
    NATIONAL_DEX_ZYGARDE_V,
    NATIONAL_DEX_TYPE_NULL_V,
    NATIONAL_DEX_SILVALLY_V_NORMAL,
    NATIONAL_DEX_TAPU_KOKO_V,
    NATIONAL_DEX_TAPU_LELE_V,
    NATIONAL_DEX_TAPU_BULU_V,
    NATIONAL_DEX_TAPU_FINI_V,
    NATIONAL_DEX_COSMOG_V,
    NATIONAL_DEX_COSMOEM_V,
    NATIONAL_DEX_SOLGALEO_V,
    NATIONAL_DEX_LUNALA_V,
    NATIONAL_DEX_NECROZMA_V,
    // Sinnoh
...
#else
    #define NATIONAL_DEX_COUNT  NATIONAL_DEX_NECROZMA_V
#endif
